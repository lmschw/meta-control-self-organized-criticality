...
class MatplotlibAnimator:
    ...
    def __init__(self, simulationData, domainSize, colours=None, redIndices=[], showRadiusForExample=False, foodEvents=[]):
        """
        Parameters:
    ...
    def prepare(self, animator, frames=100, frameInterval=10):
        ...
        return preparedAnimator.setSimulationData(self._simulationData, self._domainSize, self._colours, self._redIndices, self._showRadiusForExample, self.foodEvents)
